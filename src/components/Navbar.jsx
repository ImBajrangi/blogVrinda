                ...
                <div className="layout-content-container flex flex-col w-full max-w-[1200px] flex-1">
                    <header className="flex items-center justify-between whitespace-nowrap h-[80px]">
                        <Link to="/" className="flex items-center gap-4 text-white">
                            ...
                            <h2 className="text-white text-2xl font-bold leading-tight tracking-[-0.015em] hover:text-primary transition-colors cursor-pointer">Vrindopnishad</h2>
                        </Link>
                        <div className="flex flex-1 justify-end gap-8">
                            <div className="flex items-center gap-9">
                                <button onClick={onSearchOpen} className="text-white/80 text-sm font-medium tracking-[0.1em] uppercase hover:text-primary transition-colors group flex items-center gap-2">
                                ...
                                <Link to="/topics" className="text-white/80 text-sm font-medium tracking-[0.1em] uppercase hover:text-primary transition-colors group flex items-center gap-2">
